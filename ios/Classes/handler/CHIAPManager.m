...
@interface CHIAPManager()<SKPaymentTransactionObserver,SKProductsRequestDelegate>
{
    NSString           *_purchID;
...
@implementation CHIAPManager

#pragma mark - ♻️life cycle
+ (instancetype)shareSIAPManager{
    
    static CHIAPManager *IAPManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken,^{
        IAPManager = [[CHIAPManager alloc] init];
    });
    return IAPManager;
}
- (instancetype)init{
